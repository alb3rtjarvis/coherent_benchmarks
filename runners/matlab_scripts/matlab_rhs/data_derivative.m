% derivative data velocity
%
% SYNTAX
% derivative_ = data_derivative(time,position,VX_interpolant,VY_interpolant)
%
% INPUT ARGUMENTS
% time: scalar
...
function  derivative_ = data_derivative(time,position,VX_interpolant,VY_interpolant)
